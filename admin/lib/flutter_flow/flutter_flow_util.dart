...
class ImagePickerHelper {
  static Future<XFile?> pickImage(ImageSource source, {CameraDevice cameraDevice = CameraDevice.rear}) async {
    ImagePicker picker = ImagePicker();

    final xfile = await picker.pickImage(source: source, imageQuality: 50, preferredCameraDevice: cameraDevice);
  ...
  static Future<String?> uploadToDB(XFile pickedMedia) async {
    final mediaBytes = await pickedMedia.readAsBytes();
    final path = getStoragePath(currentUserUid, pickedMedia.name, false);
    final String? url = await uploadData(path, mediaBytes);
    return url;
  }

  static Future<String?> uploadToDBPath(String filePath) async {
  ...
  static Future<String?> uploadFileToChat(String fileName, Uint8List data, String chatId) async {
