...
class DealsRecord extends FirestoreRecord {
  ...
  // "disput_created_time" field.
  DateTime? _disputCreatedTime;
  DateTime? get disputCreatedTime => _disputCreatedTime;
  bool hasDisputCreatedTime() => _disputCreatedTime != null;
  ...
  void _initializeFields() {
    ...
    _disputCreatedTime = snapshotData['disput_created_time'] as DateTime?;
...
Map<String, dynamic> createDealsRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'disput_created_time': disputCreatedTime,
...
class DealsRecordDocumentEquality implements Equality<DealsRecord> {
  ...
  bool equals(DealsRecord? e1, DealsRecord? e2) {
    ...
    return e1?.carName == e2?.carName &&
        ...
        e1?.disputCreatedBy == e2?.disputCreatedBy &&
        e1?.disputCreatedTime == e2?.disputCreatedTime &&
        e1?.carNumber == e2?.carNumber &&
        listEquality.equals(e1?.carriers, e2?.carriers) &&
        e1?.completedBy == e2?.completedBy &&
        e1?.reviewByDiller == e2?.reviewByDiller &&
        e1?.reviewByCarrier == e2?.reviewByCarrier &&
        e1?.geoRequestDate == e2?.geoRequestDate &&
