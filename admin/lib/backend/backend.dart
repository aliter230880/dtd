...
Future maybeCreateUser(User user) async {
  ...
  if (userExists) {
    currentUserDocument = await AdminsRecord.getDocumentOnce(userRecord);
    return;
  }
  ...
  currentUserDocument = AdminsRecord.getDocumentFromData(userData, userRecord);
}

Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference
      .update(createAdminsRecordData(email: email));
}
