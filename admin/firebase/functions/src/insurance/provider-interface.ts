...
export class InsuranceQuoteError extends Error {
  constructor(
    message: string,
    public code: 'validation' | 'timeout' | 'unavailable' | 'unknown',
    public details?: any
  ) {
    super(message);
...
export class InsurancePurchaseError extends Error {
  constructor(
    message: string,
    public code: 'expired_quote' | 'payment_failed' | 'unavailable' | 'unknown',
    public details?: any
  ) {
    super(message);
