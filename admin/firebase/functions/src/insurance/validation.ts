 ...
 */
export function validateUSLocation(location: Location | null | undefined): ValidationResult {
  if (!location) {
    return {
      valid: false,
 ...
 */
export function validateVehicleValue(vehicleValue: number | null | undefined): ValidationResult {
...
export function validateQuoteInputs(
  ...
  pickupLocation: Location | null | undefined,
  deliveryLocation: Location | null | undefined,
  vehicleValue: number | null | undefined
): ValidationResult {
  // Validate VIN
