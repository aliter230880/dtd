...
describe('verifyCarrier Cloud Function', () => {
    ...
    describe('MC number verification', () => {
        it('should verify valid MC number', async () => {
            ...
            expect(result.authorityStatus).toBe('Active');
            expect(result.metadata).toBeDefined();
            expect((_a = result.metadata) === null || _a === void 0 ? void 0 : _a.mcNumber).toBe('111111');
            expect((_b = result.metadata) === null || _b === void 0 ? void 0 : _b.dotNumber).toBe('12345');
        });
...
//# sourceMappingURL=verifyCarrier.test.js.map