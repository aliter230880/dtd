...
class EditDealNamePage extends StatefulWidget {
  const EditDealNamePage({super.key, required this.deal});

  final DealsRecord? deal;
  @override
  State<EditDealNamePage> createState() => _EditDealNamePageState();
}

class _EditDealNamePageState extends State<EditDealNamePage> {
  late TextEditingController controller;

  @override
  void initState() {
    controller = TextEditingController(text: widget.deal?.carName);
    super.initState();
  }
  ...
  void save() async {
    await widget.deal?.reference.update(createDealsRecordData(carName: controller.text.trim()));
    if (mounted) context.pop();
  }

  @override
  Widget build(BuildContext context) {
    //  print('build: ${widget.deal?.carName}');
