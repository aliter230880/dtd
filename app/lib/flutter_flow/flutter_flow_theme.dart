...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFAE28C);
  late Color secondary = const Color(0xFFADADAD);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF111111);
  late Color secondaryText = const Color(0xFF6B7077);
  ...
  late Color hintColor = const Color(0xFF979797);
  late Color buttonDisabel = const Color(0xFFDEDEDE);
  late Color border = const Color(0xFF6B7077);
}
