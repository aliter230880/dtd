...
class DillerEmptyActiveDealsCompWidget extends StatefulWidget {
  ...
  @override
  State<DillerEmptyActiveDealsCompWidget> createState() => _DillerEmptyActiveDealsCompWidgetState();
}

class _DillerEmptyActiveDealsCompWidgetState extends State<DillerEmptyActiveDealsCompWidget> {
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText('z350nw0r'),
