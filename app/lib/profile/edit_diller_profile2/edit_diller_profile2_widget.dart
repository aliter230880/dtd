...
import 'edit_diller_profile2_model.dart';
export 'edit_diller_profile2_model.dart';

class EditDillerProfile2Widget extends StatefulWidget {
  const EditDillerProfile2Widget({super.key});

  @override
  State<EditDillerProfile2Widget> createState() => _EditDillerProfile2WidgetState();
}

class _EditDillerProfile2WidgetState extends State<EditDillerProfile2Widget> {
  late EditDillerProfile2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDillerProfile2Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EditDillerProfile2'});
    if (!isWeb) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'i75iiq4j' /* Добавьте номер автомолибя */,
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!(isWeb ? MediaQuery.viewInsetsOf(context).bottom > 0 : _isKeyboardVisible) &&
                            ((currentUserDocument?.dillerCars.toList() ?? []).isNotEmpty))
                          Expanded(
                            child: Padding(
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            highlightColor: Colors.transparent,
                                                            onTap: () async {
                                                              if ((currentUserDocument?.dillerCars.toList() ?? [])
                                                                      .length ==
                                                                  1) {
                                                                return;
                                                              }
