...
class _VerificationScreenState extends State<VerificationScreen>
  ...
  // cloudFunctionUrl не задан → демо-режим (нет webKey FMCSA в превью).
  ...
  Widget _header() {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Верификация документов',
              style: TextStyle(
                  fontSize: 20,
          ...
          DtdNotice(
            ...
            background: T.bg,
            border: T.divider,
            text: 'VIN и возраст проверяются реально (NHTSA vPIC, 49 CFR). '
                'FMCSA и KYC в демо-режиме: DOT 76830, 65119, 1000001, 2000002',
          ),
        ],
      ),
    );
