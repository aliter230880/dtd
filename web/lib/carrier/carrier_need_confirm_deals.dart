...
class CarrierNeedConfirmDealsWidget extends StatefulWidget {
  final int length;
  const CarrierNeedConfirmDealsWidget({super.key, this.length = 0});

  @override
  State<CarrierNeedConfirmDealsWidget> createState() => _CarrierNeedConfirmDealsWidgetState();
}

class _CarrierNeedConfirmDealsWidgetState extends State<CarrierNeedConfirmDealsWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '${FFLocalizations.of(context).getText('carrier_status_in_confirm')} (${widget.length})',
