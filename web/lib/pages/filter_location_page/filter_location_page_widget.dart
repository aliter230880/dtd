  ...
  void getLocation() async {
    try {
      ...
      if (currentUserLocationValue != null) {
        final geo = LatLng(currentUserLocationValue!.latitude, currentUserLocationValue!.longitude);
        PlaceMarkWrapper? placemarks = await _getAddressFromLatLng(geo);

        if (placemarks != null) {
          _model.locationTextController!.text = placemarks.placemark;
        }
      }
      if (mounted) {
        setState(() {
