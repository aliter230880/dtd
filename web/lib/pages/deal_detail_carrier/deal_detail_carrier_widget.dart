...
class _DealDetailCarrierWidgetState extends State<DealDetailCarrierWidget> {
  ...
  void onSendReview() async {
    ...
    if (mounted) {
      final DocumentReference? ref = await showDialog(
        context: context,
        builder: (dialogContext) {
          return Dialog(
            elevation: 0,
        ...
        title: Row(
          ...
          children: [
            if (_model.deal?.status == DealStatus.InSearch)
              Text(
                FFLocalizations.of(context).getText('81qdrxgq'),
          ...
          Padding(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton2(
                ...
                items: [
                  if (_model.deal?.status == DealStatus.InActive || _model.deal?.status == DealStatus.InConfirmComplete)
                    DropdownMenuItem(
                      value: 'disput',
                      child: Padding(
        ...
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              ...
              onTap: () async {
                try {
                  if (deal?.location == null) return;
                  String urlString =
                      'https://maps.google.com/?q=${deal!.location!.latitude},${deal!.location!.longitude}';
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          // '(${rowUsersRecord.rateCount} ${FFLocalizations.of(context).getText('93kun0dk')})',
