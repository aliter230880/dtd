...
class EditDealPricePage extends StatefulWidget {
  const EditDealPricePage({super.key, required this.deal});

  final DealsRecord? deal;
  @override
  State<EditDealPricePage> createState() => _EditDealPricePageState();
}

class _EditDealPricePageState extends State<EditDealPricePage> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: _currencyFormatter.formatString(widget.deal?.price.toString() ?? '0'));
    super.initState();
  }
  ...
  void save() async {
    final price = _currencyFormatter.getUnformattedValue();

    await widget.deal?.reference.update(createDealsRecordData(price: price.toInt()));
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                    ...
                    suffixIcon: Padding(
                      ...
                      child: Text(
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              ...
                              useGoogleFonts: false,
                              fontSize: 18,
                              color: controller.text.isNotEmpty ? null : FlutterFlowTheme.of(context).hintColor,
                            ),
                      ),
                    ),
                  ),
                  ...
                  inputFormatters: [FilteringTextInputFormatter.allow(RegExp('[0-9]')), _currencyFormatter],
                ),
              ),
            ],
          ),
