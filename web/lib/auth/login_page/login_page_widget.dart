  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          FFLocalizations.of(context).getText('k4bnarhu'),
        ...
        actions: [
          Padding(
            ...
            child: InkWell(
              ...
              child: Text(
                FFLocalizations.of(context).getText('ula38v6o'),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed:
                          ((_model.emailAddressTextController.text == '') || (_model.passwordTextController.text == ''))
                              ? null
                              : () async {
