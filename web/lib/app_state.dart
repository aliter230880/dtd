...
class FFAppState extends ChangeNotifier {
  ...
  void clearAll() {
    ...
    _creatDealFiles = [Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([])];
  }
  ...
  List<Uint8List> _creatDealFiles = [Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([]), Uint8List.fromList([])];
  List<Uint8List> get creatDealFiles => _creatDealFiles;
  set creatDealFiles(List<Uint8List> value) {
    _creatDealFiles = value;
  }

  void addToCreatDealFiles(Uint8List value) {
    _creatDealFiles.add(value);
  }

  void removeFromCreatDealFiles(Uint8List value) {
  ...
  void updateCreatDealFilesAtIndex(
    int index,
    Uint8List Function(Uint8List) updateFn,
  ) {
    _creatDealFiles[index] = updateFn(_creatDealFiles[index]);
  }

  void insertAtIndexInCreatDealFiles(int index, Uint8List value) {
