                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '19xytohs' /* У вас нет завершенных
    заказов ... */
                              ,
                            ),
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  // '${FFLocalizations.of(context).getText('all')} ${containerDealsRecordList.length.toString()} ${FFLocalizations.of(context).getText('deals1')}',
